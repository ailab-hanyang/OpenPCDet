...
def parse_config():
    ...
    parser.add_argument('--output_dir', type=str, default='/home/ailab/AILabDataset/03_Shared_Repository/jinsu/03_HMG_AVC/OpenPCDet/Real',
                         help='specify the output save directory')
